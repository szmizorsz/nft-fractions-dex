...
const WithdrawEthDialog = ({ ethBalance, accounts, nftFractionsDexContract, ethWithdrawDialogOpen, setEthWithdrawDialogOpen }) => {
    ...
    const handleCloseWithDialogContentTextReset = async () => {
        ...
        setEthWithdrawDialogOpen(false);
        setAmount('');
    };

    return (
        <>
            <Dialog open={ethWithdrawDialogOpen} onClose={handleCloseWithDialogContentTextReset} aria-labelledby="form-dialog-title" disableBackdropClick>
                <DialogTitle id="form-dialog-title">ETH withdrawal</DialogTitle>
                <DialogContent>
                    <DialogContentText>
                        {dialogContentText}
                    </DialogContentText>
...
export default WithdrawEthDialog;